...
:-----------------------|---------------------------------|-------------------------|-------------------------
*Volunteerium (Volunteer Match App)*  </br>  [Check it out!](https://volunteerium.com/) | React - Redux <br> Redux Persist <br> RTK - Vite <br>  Tailwind CSS <br> Formik & Yup <br> Toastify - Axios <br> i18Next <br> reCAPTCHA <br> NodeJS - ExpressJS <br> MongoDB - JWT <br> Amazon S3 - i18Next <br> PassportJS - Nodemailer <br> Swagger - ReDoc | ![Volunteerium](https)  | [**Source Code Frontend**](https://github.com/volunteerium-de/volunteerium) <br> [**Source Code Backend**](https://github.com/volunteerium-de/volunteerium-api) <br>
